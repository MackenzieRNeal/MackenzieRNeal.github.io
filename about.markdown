...
<h2> Recent Publications: </h2>
 ...
 <ul class="no-bullets">
              ...
              <li><a href="https://link.springer.com/article/10.1007/s11222-024-10462-0">Hidden Markov models for
                  multivariate panel data</a></li>
              <li><a href="https://arxiv.org/abs/2305.16464">Flexible Variable Selection for Clustering and
                  Classification</a></li>
              <li><a href="https://link.springer.com/chapter/10.1007/978-3-031-65993-5_39">Variable Selection for
                  Clustering Three-Way Data</a></li>
</ul>
  ...
  <li><b>Robust clustering using maximized mutual information</b></li>
              <ul class="no-bullets indented-list">
                <li>Invited Talk - 19th International Joint Conference on Computational and Financial Econometrics (CFE)
                  and
                  Computational and Methodological Statistics (CMStatistics), London, UK, December 13-15, 2025. </li>
              </ul>
              <li><b>Robust clustering using maximized mutual information</b></li>
              <ul class="no-bullets indented-list">
                <li>Invited Talk - 15th Scientific Meeting of the Classification and Data Analysis Group of the Italian
                  Statistical Society (CLADAG), Naples, Italy, September 8-10, 2025. </li>
              </ul>
              <li><b>Parsimonious hidden Markov modes for multivariate longitudinal data</b></li>
              <ul class="no-bullets indented-list">
                <li>Poster - 2025 Classification Society Annual Meeting, Ottawa, Canada, June 17-19, 2025. </li>
              </ul>
              <li><b>A comparison of parsimonious hidden Markov models for longitudinal data</b></li>
              <ul class="no-bullets indented-list">
                <li>Invited Talk - 18th International Joint Conference on Computational and Financial Econometrics (CFE)
                  and Computational and
                  Methodological Statistics (CMStatistics), London, UK, December 14-16, 2024. </li>
              </ul>
